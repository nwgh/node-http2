...
// The main governing power behind the http2js API design is that it should look very similar to the
...
// ------------------------------------
//
// - **Class: http2js.Endpoint**: an API for using the raw HTTP/2 framing layer. For documentation
//   see [protocol/endpoint.js](protocol/endpoint.html).
//
// - **Class: http2js.Server**
...
//     socket.
//
// - **http2js.createServer(options, [requestListener])**: additional option:
//   - **log**: an optional [bunyan](https://github.com/trentm/node-bunyan) logger object
//
// - **Class: http2js.ServerResponse**
...
//     ones accepted by `http2js.request`. Returns a ServerResponse object that can be used to send
...
//
// - **http2js.request(options, [callback])**:
//   - similar to http.request
//
// - **http2js.get(options, [callback])**:
//   - similar to http.get
//
// - **Class: http2js.ClientRequest**
...
//
// - **Class: http2js.IncomingRequest (IncomingMessage)**
...
//
// - **Class: http2js.IncomingPromise (IncomingRequest)**
